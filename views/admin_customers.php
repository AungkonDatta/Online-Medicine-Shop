                ...
                <tbody id="tableBody">
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td><?= h($cust['email']) ?></td>
                            <td><?= h($cust['phone'] ?? '—') ?></td>
                            <td><?= h($cust['address'] ?? '—') ?></td>
                            <td><?= date('d M Y', strtotime($cust['created_at'])) ?></td>
                            <td class="text-right">
                                <a class="btn-sm btn-delete"
                                   href="index.php?page=admin_customers&action=delete&id=<?= $cust['id'] ?>"
                                   onclick="return confirm('Delete customer <?= h(addslashes($cust['name'])) ?>? This will also remove their cart and orders.')">
                                   Delete
                                </a>
                            </td>
                        </tr>
    ...
    function render(rows) {
        ...
        rows.forEach(function (c, i) {
            html += '<tr>' +
                ...
                '<td class="text-right">' +
                    '<a class="btn-sm btn-delete" href="index.php?page=admin_customers&action=delete&id=' + c.id +
